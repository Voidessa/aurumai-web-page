    ...
    <section id="hero" className="relative min-h-[80vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden py-20 md:py-32">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 h-full min-h-[500px] md:min-h-[600px] bg-transparent rounded-2xl border border-glass-border relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row h-full min-h-[850px] md:min-h-[600px] relative z-10">
          ...
          <div className="absolute bottom-0 left-0 right-0 md:relative md:flex-1 h-[600px] md:h-auto md:min-h-[500px] scale-[2.2] sm:scale-[1.8] md:scale-100 z-10" style={{ transformOrigin: 'center bottom' }}>
            {splineSceneUrl ? (
              <SplineScene 
